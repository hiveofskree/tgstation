...
/obj/item/clothing/glasses/nano_goggles
	...
	alternate_worn_icon = 'skree/icons/mob/nanosuit.dmi'
	icon = 'skree/icons/obj/nanosuit.dmi'
	...
	if(!shutdown && (forced || (cell?.charge && mode != suitmode)))
		...
		switch(suitmode)
			if(NANO_ARMOR)
				...
				Wearer.remove_trait(NANO_SPEED)
...
/datum/action/item_action/nanosuit/goggletoggle
	name = "Night Vision"
	icon_icon = 'skree/icons/mob/actions/actions_nanosuit.dmi'
...
/datum/martial_art/nanosuit/proc/HeadStomp(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	if(head)
		...
		playsound(get_turf(A), 'skree/sound/misc/squishy.ogg', 75, TRUE, -1)
...
/obj/item/clothing/suit/space/hardsuit/nano/proc/open_mode_menu(mob/living/user)
	...
	"armor" = image(icon = 'skree/icons/mob/actions/actions_nanosuit.dmi', icon_state = "armor_menu"),
	"speed" = image(icon = 'skree/icons/mob/actions/actions_nanosuit.dmi', icon_state = "speed_menu"),
	"cloak" = image(icon = 'skree/icons/mob/actions/actions_nanosuit.dmi', icon_state = "cloak_menu"),
	"strength" = image(icon = 'skree/icons/mob/actions/actions_nanosuit.dmi', icon_state = "strength_menu")
	)
