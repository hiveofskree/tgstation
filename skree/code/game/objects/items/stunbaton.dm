...
/obj/item/melee/baton/stungun
	...
	icon = 'skree/icons/obj/items_and_weapons.dmi'
	icon_state = "stungun"
	item_state = "stungun"
	lefthand_file = 'skree/icons/mob/inhands/lefthand.dmi'
	righthand_file = 'skree/icons/mob/inhands/righthand.dmi'
...
/obj/item/melee/baton/stungun/process()
	...
	if(selfcharge)
		...
		if(cell && cell.charge < 300)
			playsound(src, 'skree/sound/misc/charge.ogg', 35, FALSE, pressure_affected = FALSE)
			update_icon()

/obj/item/melee/baton/stungun/baton_stun()
	..()
	playsound(loc, 'skree/sound/weapons/stungun.ogg', 75, 1, -1)
	update_icon()
